defmodule HalostatueCa.MixProject do
  ...
  defp deps do
    [
      ...
      {:req, "~> 0.5"},
      # {:solid, "~> 1.1"},
      {:tableau, "~> 0.30.0", github: "halostatue/tableau", branch: "upgrade-mdex", override: true},
      ...
      # {:tableau_page_feedback_extension, "~> 1.0", path: Path.expand("~/oss/halostatue/tableau_page_feedback_extension")},
